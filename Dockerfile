...
COPY container_encoder_train_src/ container_encoder_train_src/
COPY container_predicter_train_src/ container_predicter_train_src/
COPY container_policy_train_src/ container_policy_train_src/
